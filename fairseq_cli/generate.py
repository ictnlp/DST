...
def _main(cfg: DictConfig, output_file):
    ...
    for sample in progress:
        ...
        gen_timer.start()
        hypos, rw_seq, time_seq = task.inference_step(
            generator,
            models,
            sample,
            ...
            soft_attention=True,
            preRead=cfg.generation.preRead
        )
        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            rw01 = d201(rw_seq[i], sample["net_input"]["src_lengths"][i] - 1)
            rw.append(rw01)
            ...
            for j, hypo in enumerate(hypos[i][: cfg.generation.nbest]):
                ...
                if not cfg.common_eval.quiet:
                    ...
                    str_seq = [str(num) for num in time_seq]
                    print(
                        "TI-{}\t{}\t{}".format(sample_id, 0, str_seq),
                        file=output_file,
                    )

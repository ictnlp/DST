...
class AdaptiveAttnMultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        # mask the source tokens according to the attn allocation
        ...
        # the training signal for summation constraint
        ...
        # segment the attn_weights matrix into three parts
        ...
        # source to (source, target) attention
        ...
        # The forward and backward algorithm for target to (source, target) matrix
        if self.training:
        ...
        # the final distribution for attn matrix
        ...
        return attn, attn_weights, attend_src_weights_train.contiguous().view(bsz, self.num_heads, -1, src_seqlen)[:, :1, :, :], signal
